...
import (
	...
	blobstream "github.com/lyfeblocnetwork/lyfebloc/x/blobstream/module"

	"github.com/lyfeblocnetwork/lyfebloc/app"
	"github.com/lyfeblocnetwork/lyfebloc/x/blobstream/keeper"
	...
	encoding "github.com/lyfeblocnetwork/lyfebloc/test/util/encoding"
)
...
func init() {
	...
	config.SetBech32PrefixForValidator("lyfeblocvaloper", "lyfeblocvaloperpub")
}
...
func NewTestMsgCreateValidator(
	...
	out, err := stakingtypes.NewMsgCreateValidator(
		...
		stakingtypes.Description{
			...
			SecurityContact: "lyfebloc17p9rzwnnfxcjp32un9ug7yhhzgtkhvl9jfksztgw5uh69wac2pgs06edvm",
