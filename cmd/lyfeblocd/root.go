...
func NewRootCmd() (*cobra.Command, sdktestutil.TestEncodingConfig) {
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		lyfeblocclient.KeyCommands(app.DefaultNodeHome),
	)
