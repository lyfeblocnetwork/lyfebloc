...
import (
	...
	_ "github.com/lyfeblocnetwork/lyfebloc/server/config/migration" // Add this import to set up the proper app.toml migration logic for sdk v0.50
)
...
const (
	...
	DefaultRosettaDenomToSuggest = "alyfe"
...
func AppConfig(denom string) (string, interface{}) {
	...
	//
	// In lyfebloc, we set the min gas prices to 0.
	if denom != "" {
