...
import (
	...
	lyfeblocapp "github.com/lyfeblocnetwork/lyfebloc/app"
...
func Call(ctx sdk.Context, app *lyfeblocapp.Lyfebloc, args CallArgs) (res abci.ExecTxResult, ethRes *evmtypes.MsgEthereumTxResponse, err error) {
	var (
		nonce    uint64
	...
	res, err = lyfeblocutil.DeliverEthTx(app, args.PrivKey, msg)
	if err != nil {
...
func CallContractAndCheckLogs(ctx sdk.Context, app *lyfeblocapp.Lyfebloc, cArgs CallArgs, logCheckArgs testutil.LogCheckArgs) (abci.ExecTxResult, *evmtypes.MsgEthereumTxResponse, error) {
