...
import (
	...
	cmnfactory "github.com/lyfeblocnetwork/lyfebloc/testutil/integration/common/factory"
...
func (s *PrecompileTestSuite) setupVestingAccount(funder, vestAcc testkeyring.Key) *vestingtypes.ClawbackVestingAccount {
	...
	fundMsg := vestingtypes.NewMsgFundVestingAccount(
		...
		vestAcc.AccAddr,
		vestingStart,
		lyfeblocutil.TestVestingSchedule.LockupPeriods,
		lyfeblocutil.TestVestingSchedule.VestingPeriods,
	)
