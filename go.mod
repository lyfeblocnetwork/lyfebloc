module github.com/lyfeblocnetwork/lyfebloc

go 1.22.7

replace (
	// lyfebloc-core
	github.com/cometbft/cometbft => github.com/lyfeblocnetwork/lyfebloc-core v0.0.5-cmt-v0.38.2
	github.com/gogo/protobuf => github.com/regen-network/protobuf v1.3.3-alpha.regen.1

	github.com/lyfeblocnetwork/lyfebloc/pkg/blob => ./pkg/blob
	github.com/lyfeblocnetwork/lyfebloc/pkg/namespace => ./pkg/namespace
)
...
require (
	...
	github.com/lyfeblocnetwork/lyfebloc/pkg/blob v0.0.3
	github.com/lyfeblocnetwork/lyfebloc/pkg/namespace v0.0.3
