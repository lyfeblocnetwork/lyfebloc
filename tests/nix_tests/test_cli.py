...
def test_block_cmd(lyfebloc_cluster):
    """
    - start 2 lyfebloc nodes
    - wait for a certain height
    - stop the node1
    - use the 'block' cli cmd
    - restart lyfebloc node1
    """

    # wait for specific height
    node1 = lyfebloc_cluster.cosmos_cli(1)
...
def test_tx_flags(lyfebloc_cluster):
    ...
    test_cases = [
        {
            ...
            "flags": {"fees": "5000000000alyfe", "gas_prices": "50000alyfe"},
            "exp_err": True,
        ...
        },
        {
            ...
            "flags": {"fees": "10alyfe", "gas": 50000, "gas_prices": None},
            "exp_err": True,
            "err_msg": "insufficient fee",
        },
        {
            "name": "fail - insufficient gas",
            "flags": {"fees": "500000000000alyfe", "gas": 1, "gas_prices": None},
            "exp_err": True,
            "err_msg": "out of gas",
        },
        {
            ...
            "flags": {
                "fees": "10000000000000000000alyfe",
                "gas": 1500000,
                "gas_prices": None,
            },
            "exp_err": False,
        ...
        },
        {
            ...
            "flags": {"gas_prices": "100000000000alyfe", "gas": 1500000},
            "exp_err": False,
            "err_msg": None,
        },
        {
    ...
    for tc in test_cases:
        try:
            res = node.transfer(
                "signer1",
                "lyfebloc10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky",
                "100000000000000alyfe",
                False,
                **tc["flags"],
            )
            if not tc["exp_err"]:
