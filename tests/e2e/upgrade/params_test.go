	...
	testcases := []struct {
	...
	}{
		{
			...
			vars: envVars{
				...
				chainID:        "lyfebloc_9123-1",
				skipCleanup:    "true",
				mountPath:      "/tmp/lyfebloc",
			},
			want: Params{
				MountPath: "/tmp/lyfebloc",
				Versions: []VersionConfig{
					{"v0.1.0", "v0.1.0", lyfeblocRepo},
					{"v0.2.0", "v0.2.0", lyfeblocRepo},
				},
				ChainID:     "lyfebloc_9123-1",
				WorkDirRoot: wd,
			},
		...
		},
		{
			...
			want: Params{
				...
				Versions: []VersionConfig{
					{"v0.1.0", "v0.1.0", lyfeblocRepo},
					{"v0.2.0", "v0.2.0", lyfeblocRepo},
					{latestVersionName, LocalVersionTag, lyfeblocRepo},
				},
		...
		},
		{
			...
			want: Params{
				MountPath: defaultMountPath,
				Versions: []VersionConfig{
					{"v0.1.0-rc1", "v0.1.0-rc1", lyfeblocRepo},
					{"v0.2.0-rc2", "v0.2.0-rc2", lyfeblocRepo},
				},
				ChainID:     defaultChainID,
				WorkDirRoot: wd,
			},
		...
		},
		{
			...
			want: Params{
				MountPath: defaultMountPath,
				Versions: []VersionConfig{
					{defaultInitialVersion, defaultInitialVersion, lyfeblocRepo},
					{latestVersionName, LocalVersionTag, lyfeblocRepo},
				},
				ChainID:     defaultChainID,
				WorkDirRoot: wd,
