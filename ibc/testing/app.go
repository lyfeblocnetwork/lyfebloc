...
var DefaultTestingAppInit func(chainID string) func() (ibcgotesting.TestingApp, map[string]json.RawMessage) = lyfeblocapp.SetupTestingApp
...
func SetupWithGenesisValSet(t *testing.T, valSet *cmttypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, balances ...banktypes.Balance) ibcgotesting.TestingApp {
	...
	_, err = app.InitChain(
		&abci.RequestInitChain{
			...
			ConsensusParams: lyfeblocapp.DefaultConsensusParams,
