...
import (
	...
	appconsts "github.com/lyfeblocnetwork/lyfebloc/pkg/appconsts"
...
func (k Keeper) BeginBlocker(ctx sdk.Context) error {
	...
	vBlocAmount := fees.AmountOf(appconsts.BondDenom)
	amount := sdk.NewCoin(appconsts.BondDenom, vBlocAmount)
