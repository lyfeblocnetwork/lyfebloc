...
import (
	...
	"github.com/lyfeblocnetwork/lyfebloc/x/ibc/transfer/keeper"
	...
	testCases := []struct {
	...
	}{
		{
			...
			func() *types.MsgTransfer {
				transferMsg := types.NewMsgTransfer("transfer", "channel-0", sdk.NewCoin("alyfe", math.NewInt(10)), sender.AccAddr.String(), "", timeoutHeight, 0, "")
				return transferMsg
			},
			true,
		},
