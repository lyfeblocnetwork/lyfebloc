...
1. Determine the
   [`SubtreeWidth`](https://lyfebloc/blob/v1.0.0-rc2/pkg/shares/non_interactive_defaults.go#L94-L116)
...
See
[`CreateCommitment`](https://lyfebloc/blob/v1.0.0-rc2/x/blob/types/payforblob.go#L169-L236)
...
The steps in the
[`SubmitPayForBlobs`](https://lyfebloc/blob/v1.0.0-rc2/x/blob/payforblob.go#L15-L54)
