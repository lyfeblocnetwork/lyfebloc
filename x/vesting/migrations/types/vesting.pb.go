...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "lyfebloc.vesting.v1.ClawbackVestingAccount")
}

func init() { proto.RegisterFile("lyfebloc/vesting/v1/vesting.proto", fileDescriptor_5f1a3c86c0cebe5f) }
