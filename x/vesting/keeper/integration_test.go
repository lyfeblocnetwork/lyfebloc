...
import (
	...
	"github.com/lyfeblocnetwork/lyfebloc/testutil/integration/common/factory"
	lyfeblocfactory "github.com/lyfeblocnetwork/lyfebloc/testutil/integration/lyfebloc/factory"
	...
	"github.com/lyfeblocnetwork/lyfebloc/x/vesting/types"
...
type KeeperTestSuite struct {
	...
	factory lyfeblocfactory.TxFactory
}
...
//
// Example:
// 21/10 Employee joins Lyfebloc and vesting starts
...
var _ = Describe("Clawback Vesting Account - Smart contract", func() {
	...
	BeforeEach(func() {
		...
		contractAddr, err = s.factory.DeployContract(
			...
			evmtypes.EvmTxArgs{},
			lyfeblocfactory.ContractDeploymentData{
				Contract:        contract,
