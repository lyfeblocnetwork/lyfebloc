...
import (
	...
	"github.com/lyfeblocnetwork/lyfebloc/x/evm/core/logger"
	"github.com/lyfeblocnetwork/lyfebloc/x/evm/core/tracers"
...
func getChainID(ctx sdk.Context, chainID int64) (*big.Int, error) {
	if chainID == 0 {
		return lyfebloctypes.ParseChainID(ctx.ChainID())
	}
