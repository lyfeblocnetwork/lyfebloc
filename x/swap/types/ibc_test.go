...
func TestEncodePacketMetadata_ExactAmountIn(t *testing.T) {
	...
	packetMetadata := PacketMetadata{
		Swap: &SwapMetadata{
			InterfaceProvider: "lyfebloc18atdu5vvsg95sdpvdwsv7kevlzg8jhtuk7hs4y",
			Route: &Route{
				DenomIn:  "tokenIn",
				DenomOut: "tokenOut",
				Strategy: &Route_Pool{
...
func TestEncodePacketMetadataNoForward_ExactAmountIn(t *testing.T) {
	...
	require.Equal(t, js, `{"swap":{"interface_provider":"lyfebloc18atdu5vvsg95sdpvdwsv7kevlzg8jhtuk7hs4y","route":{"denom_in":"tokenIn","denom_out":"tokenOut","pool":{"pool_id":"1"}},"exact_amount_in":{"min_amount_out":"1"}}}`)
...
func TestEncodePacketMetadata_ExactAmountInSeries(t *testing.T) {
	...
	require.Equal(t, js, `{"swap":{"interface_provider":"lyfebloc18atdu5vvsg95sdpvdwsv7kevlzg8jhtuk7hs4y","route":{"denom_in":"tokenIn","denom_out":"tokenOut","series":{"routes":[{"denom_in":"tokenIn","denom_out":"tokenOut","pool":{"pool_id":"1"}},{"denom_in":"tokenOut","denom_out":"tokenOut2","pool":{"pool_id":"2"}}]}},"exact_amount_in":{"min_amount_out":"1"},"forward":{"receiver":"cosmos1qnk2n4nlkpw9xfqntladh74w6ujtulwn7j8za9","port":"transfer","channel":"channel-2","retries":2}}}`)
...
func TestEncodePacketMetadata_ExactAmountOut(t *testing.T) {
	...
	require.Equal(t, js, `{"swap":{"interface_provider":"lyfebloc18atdu5vvsg95sdpvdwsv7kevlzg8jhtuk7hs4y","route":{"denom_in":"tokenIn","denom_out":"tokenOut","pool":{"pool_id":"1"}},"exact_amount_out":{"amount_out":"1000","change":{"receiver":"cosmos1qnk2n4nlkpw9xfqntladh74w6ujtulwn7j8za9","port":"transfer","channel":"channel-2","retries":2}},"forward":{"receiver":"cosmos1qnk2n4nlkpw9xfqntladh74w6ujtulwn7j8za9","port":"transfer","channel":"channel-2","timeout":"3600s","retries":2}}}`)
...
func TestDecodePacketMetadata_NoForward(t *testing.T) {
	memoString := `{"swap":{"interface_provider":"lyfebloc18atdu5vvsg95sdpvdwsv7kevlzg8jhtuk7hs4y","route":{"denom_in":"tokenIn","denom_out":"tokenOut","pool":{"pool_id":"1"}},"exact_amount_in":{"min_amount_out":"1"}}}`
