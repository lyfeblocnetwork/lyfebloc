BINARY=./build/lyfeblocd
CHAIN_DIR=./data
CHAINID_1=test
NODE_HOME=$CHAIN_DIR/$CHAINID_1
BINARY_GOV_TOKEN=uvbloc
BINARY_FEE_TOKEN=ubloc
VAL1=val
FAUCET=faucet
USER1=user1
USER2=user2
...
VAL_ADDRESS_1=lyfebloc1a8jcsmla6heu99ldtazc27dna4qcd4jyvln5d8
FAUCET_ADDRESS_1=lyfebloc1d6zd6awgjxuwrf4y863c9stz9m0eec4gnxuf79
USER_ADDRESS_1=lyfebloc155u042u8wk3al32h3vzxu989jj76k4zcc6d03n
USER_ADDRESS_2=lyfebloc1v0h8j7x7kfys29kj4uwdudcc9y0nx6tw2f955q
USER_ADDRESS_3=lyfebloc1y3t7sp0nfe2nfda7r9gf628g6ym6e7d43k5288
USER_ADDRESS_4=lyfebloc1pp2ruuhs0k7ayaxjupwj4k5qmgh0d72w8zu30p
