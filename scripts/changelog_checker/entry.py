...
def check_link(link: str, pr_number: int) -> Tuple[str, List[str]]:
    ...
    if not link.startswith("https://github.com/lyfeblocnetwork/lyfebloc/pull/"):
        fixed = f"https://github.com/lyfeblocnetwork/lyfebloc/pull/{pr_number}"
        problems.append(f'PR link should point to lyfebloc repository: "{link}"')
