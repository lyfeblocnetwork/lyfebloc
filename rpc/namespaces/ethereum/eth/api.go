...
import (
	...
	rpctypes "github.com/lyfeblocnetwork/lyfebloc/rpc/types"
	"github.com/lyfeblocnetwork/lyfebloc/types"
	evmtypes "github.com/lyfeblocnetwork/lyfebloc/x/evm/types"
)

// The Ethereum API allows applications to connect to an Lyfebloc node that is
// part of the Lyfebloc blockchain. Developers can interact with on-chain EVM data
