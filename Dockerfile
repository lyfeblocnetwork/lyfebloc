...
WORKDIR /go/src/github.com/lyfeblocnetwork/lyfebloc
...
COPY --from=build-env /go/src/github.com/lyfeblocnetwork/lyfebloc/build/lyfeblocd /usr/bin/lyfeblocd
...
RUN apk add --no-cache \
    ...
    lz4 \
    rclone \
    && addgroup -g 1000 lyfebloc \
    && adduser -S -h /home/lyfebloc -D lyfebloc -u 1000 -G lyfebloc
