...
func DefaultConfig() Config {
	...
	app := app.NewLyfebloc(log.NewNopLogger(), dbm.NewMemDB(), nil, true, nil, dir, 0, simutils.NewAppOptionsWithFlagHome(dir), baseapp.SetChainID(chainID))
	return Config{
		Codec:             app.AppCodec(),
		...
		NumValidators:     4,
		BondDenom:         "alyfe",
		MinGasPrices:      fmt.Sprintf("0.000006%s", lyfebloctypes.AttoLyfebloc),
		AccountTokens:     sdk.TokensFromConsensusPower(1000000000000000000, lyfebloctypes.PowerReduction),
		StakingTokens:     sdk.TokensFromConsensusPower(500000000000000000, lyfebloctypes.PowerReduction),
		BondedTokens:      sdk.TokensFromConsensusPower(100000000000000000, lyfebloctypes.PowerReduction),
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		customAppTemplate, _ := config.AppConfig(lyfebloctypes.AttoLyfebloc)
