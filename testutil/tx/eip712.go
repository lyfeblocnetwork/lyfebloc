...
import (
	...
	cryptocodec "github.com/lyfeblocnetwork/lyfebloc/crypto/codec"
	"github.com/lyfeblocnetwork/lyfebloc/ethereum/eip712"
...
func PrepareEIP712CosmosTx(
	...
	accNumber := appLyfebloc.AccountKeeper.GetAccount(ctx, from).GetAccountNumber()

	nonce, err := appLyfebloc.AccountKeeper.GetSequence(ctx, from)
	if err != nil {
		return nil, err
	}
