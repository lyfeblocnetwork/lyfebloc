...
import (
	...
	"github.com/lyfeblocnetwork/lyfebloc/wallets/ledger"
	"github.com/lyfeblocnetwork/lyfebloc/wallets/ledger/mocks"
	"github.com/lyfeblocnetwork/lyfebloc/wallets/usbwallet"
)
...
func (suite *LedgerTestSuite) getMockTxProtobuf() []byte {
	...
	msg := bankTypes.NewMsgSend(
		sdk.MustAccAddressFromBech32("lyfebloc10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky"),
		sdk.MustAccAddressFromBech32("lyfebloc1fx944mzagwdhx0wz7k9tfztc8g3lkfk6rrgv6l"),
		[]sdk.Coin{
			{
				Denom:  "atom",
