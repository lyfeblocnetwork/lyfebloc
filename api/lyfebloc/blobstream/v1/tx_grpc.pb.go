...
const (
	Msg_UpdateParams_FullMethodName       = "/lyfebloc.blobstream.v1.Msg/UpdateParams"
	Msg_RegisterEvmAddress_FullMethodName = "/lyfebloc.blobstream.v1.Msg/RegisterEvmAddress"
)
