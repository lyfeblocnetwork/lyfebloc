...
const (
	Query_Params_FullMethodName                         = "/lyfebloc.blobstream.v1.Query/Params"
	Query_AttestationRequestByNonce_FullMethodName      = "/lyfebloc.blobstream.v1.Query/AttestationRequestByNonce"
	Query_LatestAttestationNonce_FullMethodName         = "/lyfebloc.blobstream.v1.Query/LatestAttestationNonce"
	Query_EarliestAttestationNonce_FullMethodName       = "/lyfebloc.blobstream.v1.Query/EarliestAttestationNonce"
	Query_LatestValsetRequestBeforeNonce_FullMethodName = "/lyfebloc.blobstream.v1.Query/LatestValsetRequestBeforeNonce"
	Query_LatestUnbondingHeight_FullMethodName          = "/lyfebloc.blobstream.v1.Query/LatestUnbondingHeight"
	Query_DataCommitmentRangeForHeight_FullMethodName   = "/lyfebloc.blobstream.v1.Query/DataCommitmentRangeForHeight"
	Query_LatestDataCommitment_FullMethodName           = "/lyfebloc.blobstream.v1.Query/LatestDataCommitment"
	Query_EvmAddress_FullMethodName                     = "/lyfebloc.blobstream.v1.Query/EvmAddress"
)
