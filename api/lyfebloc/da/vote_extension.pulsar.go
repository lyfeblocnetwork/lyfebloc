...
func init() {
	file_lyfebloc_da_vote_extension_proto_init()
	md_VoteExtension = File_lyfebloc_da_vote_extension_proto.Messages().ByName("VoteExtension")
...
func (x *VoteExtension) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_da_vote_extension_proto_msgTypes[0]
...
func (x *fastReflection_VoteExtension) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.da.VoteExtension.data":
		return len(x.Data) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.da.VoteExtension"))
		}
		panic(fmt.Errorf("message lyfebloc.da.VoteExtension does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_VoteExtension) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.da.VoteExtension does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_VoteExtension) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.da.VoteExtension", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: lyfebloc/da/vote_extension.proto
...
func (*VoteExtension) Descriptor() ([]byte, []int) {
	return file_lyfebloc_da_vote_extension_proto_rawDescGZIP(), []int{0}
}
...
var File_lyfebloc_da_vote_extension_proto protoreflect.FileDescriptor

var file_lyfebloc_da_vote_extension_proto_rawDesc = []byte{
	0x0a, 0x20, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2f, 0x64, 0x61, 0x2f, 0x76, 0x6f,
	0x74, 0x65, 0x5f, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f,
	...
	,
...
var (
	file_lyfebloc_da_vote_extension_proto_rawDescOnce sync.Once
	file_lyfebloc_da_vote_extension_proto_rawDescData = file_lyfebloc_da_vote_extension_proto_rawDesc
)

func file_lyfebloc_da_vote_extension_proto_rawDescGZIP() []byte {
	file_lyfebloc_da_vote_extension_proto_rawDescOnce.Do(func() {
		file_lyfebloc_da_vote_extension_proto_rawDescData = protoimpl.X.CompressGZIP(file_lyfebloc_da_vote_extension_proto_rawDescData)
	})
	return file_lyfebloc_da_vote_extension_proto_rawDescData
}

var file_lyfebloc_da_vote_extension_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_lyfebloc_da_vote_extension_proto_goTypes = []interface{}{
	(*VoteExtension)(nil), // 0: lyfebloc.da.VoteExtension
	(*PublishedData)(nil), // 1: lyfebloc.da.PublishedData
}
var file_lyfebloc_da_vote_extension_proto_depIdxs = []int32{
	1, // 0: lyfebloc.da.VoteExtension.data:type_name -> lyfebloc.da.PublishedData
...
func init() { file_lyfebloc_da_vote_extension_proto_init() }
func file_lyfebloc_da_vote_extension_proto_init() {
	if File_lyfebloc_da_vote_extension_proto != nil {
		return
	}
	file_lyfebloc_da_params_proto_init()
	file_lyfebloc_da_published_data_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_lyfebloc_da_vote_extension_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lyfebloc_da_vote_extension_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_lyfebloc_da_vote_extension_proto_goTypes,
		DependencyIndexes: file_lyfebloc_da_vote_extension_proto_depIdxs,
		MessageInfos:      file_lyfebloc_da_vote_extension_proto_msgTypes,
	}.Build()
	File_lyfebloc_da_vote_extension_proto = out.File
	file_lyfebloc_da_vote_extension_proto_rawDesc = nil
	file_lyfebloc_da_vote_extension_proto_goTypes = nil
	file_lyfebloc_da_vote_extension_proto_depIdxs = nil
}
