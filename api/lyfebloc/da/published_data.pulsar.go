...
func init() {
	...
	md_PublishedData = File_lyfebloc_da_published_data_proto.Messages().ByName("PublishedData")
...
func (x *PublishedData) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_da_published_data_proto_msgTypes[0]
...
func (x *fastReflection_PublishedData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.da.PublishedData.metadata_uri":
		return x.MetadataUri != ""
	case "lyfebloc.da.PublishedData.parity_shard_count":
		return x.ParityShardCount != uint64(0)
	case "lyfebloc.da.PublishedData.shard_double_hashes":
		return len(x.ShardDoubleHashes) != 0
	case "lyfebloc.da.PublishedData.timestamp":
		return x.Timestamp != nil
	case "lyfebloc.da.PublishedData.status":
		return x.Status != ""
	case "lyfebloc.da.PublishedData.publisher":
		return x.Publisher != ""
	case "lyfebloc.da.PublishedData.challenger":
		return x.Challenger != ""
	case "lyfebloc.da.PublishedData.collateral":
		return len(x.Collateral) != 0
	case "lyfebloc.da.PublishedData.challenge_timestamp":
		return x.ChallengeTimestamp != nil
	case "lyfebloc.da.PublishedData.data_source_info":
		return x.DataSourceInfo != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.da.PublishedData"))
		}
		panic(fmt.Errorf("message lyfebloc.da.PublishedData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PublishedData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.da.PublishedData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PublishedData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "lyfebloc.da.PublishedData.metadata_uri":
		panic(fmt.Errorf("field metadata_uri of message lyfebloc.da.PublishedData is not mutable"))
	case "lyfebloc.da.PublishedData.parity_shard_count":
		panic(fmt.Errorf("field parity_shard_count of message lyfebloc.da.PublishedData is not mutable"))
	case "lyfebloc.da.PublishedData.status":
		panic(fmt.Errorf("field status of message lyfebloc.da.PublishedData is not mutable"))
	case "lyfebloc.da.PublishedData.publisher":
		panic(fmt.Errorf("field publisher of message lyfebloc.da.PublishedData is not mutable"))
	case "lyfebloc.da.PublishedData.challenger":
		panic(fmt.Errorf("field challenger of message lyfebloc.da.PublishedData is not mutable"))
	case "lyfebloc.da.PublishedData.data_source_info":
		panic(fmt.Errorf("field data_source_info of message lyfebloc.da.PublishedData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.da.PublishedData"))
		}
...
func (x *fastReflection_PublishedData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.da.PublishedData", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_lyfebloc_da_published_data_proto_init()
	md_Proof = File_lyfebloc_da_published_data_proto.Messages().ByName("Proof")
...
func (x *Proof) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_da_published_data_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Proof) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.da.Proof.metadata_uri":
		return x.MetadataUri != ""
	case "lyfebloc.da.Proof.sender":
		return x.Sender != ""
	case "lyfebloc.da.Proof.indices":
		return len(x.Indices) != 0
	case "lyfebloc.da.Proof.proofs":
		return len(x.Proofs) != 0
	case "lyfebloc.da.Proof.is_valid_data":
		return x.IsValidData != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.da.Proof"))
		}
		panic(fmt.Errorf("message lyfebloc.da.Proof does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Proof) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.da.Proof does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Proof) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "lyfebloc.da.Proof.proofs":
		...
		return protoreflect.ValueOfList(value)
	case "lyfebloc.da.Proof.metadata_uri":
		panic(fmt.Errorf("field metadata_uri of message lyfebloc.da.Proof is not mutable"))
	case "lyfebloc.da.Proof.sender":
		panic(fmt.Errorf("field sender of message lyfebloc.da.Proof is not mutable"))
	case "lyfebloc.da.Proof.is_valid_data":
		panic(fmt.Errorf("field is_valid_data of message lyfebloc.da.Proof is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.da.Proof"))
		}
...
func (x *fastReflection_Proof) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.da.Proof", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: lyfebloc/da/published_data.proto
...
func (*PublishedData) Descriptor() ([]byte, []int) {
	return file_lyfebloc_da_published_data_proto_rawDescGZIP(), []int{0}
}
...
func (*Proof) Descriptor() ([]byte, []int) {
	return file_lyfebloc_da_published_data_proto_rawDescGZIP(), []int{1}
}
...
var File_lyfebloc_da_published_data_proto protoreflect.FileDescriptor

var file_lyfebloc_da_published_data_proto_rawDesc = []byte{
	0x0a, 0x20, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2f, 0x64, 0x61, 0x2f, 0x70, 0x75,
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x64, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x0b, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2e, 0x64, 0x61, 0x1a,
	...
	0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2f, 0x64, 0x61, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d,
	...
	,
	...
	,
	...
	0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x61, 0x74, 0x65, 0x72, 0x61,
	0x6c, 0x12, 0x55, 0x0a, 0x13, 0x63, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x5f, 0x74,
	...
	0x90, 0xdf, 0x1f, 0x01, 0x52, 0x12, 0x63, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x54,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x28, 0x0a, 0x10, 0x64, 0x61, 0x74, 0x61,
	0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0a, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0e, 0x64, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x6e,
	0x66, 0x6f, 0x22, 0x98, 0x01, 0x0a, 0x05, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x12, 0x21, 0x0a, 0x0c,
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x75, 0x72, 0x69, 0x18, 0x01, 0x20, 0x01,
	...
	0x06, 0x73, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x69, 0x6e, 0x64, 0x69, 0x63,
	...
	,
}

var (
	file_lyfebloc_da_published_data_proto_rawDescOnce sync.Once
	file_lyfebloc_da_published_data_proto_rawDescData = file_lyfebloc_da_published_data_proto_rawDesc
)

func file_lyfebloc_da_published_data_proto_rawDescGZIP() []byte {
	file_lyfebloc_da_published_data_proto_rawDescOnce.Do(func() {
		file_lyfebloc_da_published_data_proto_rawDescData = protoimpl.X.CompressGZIP(file_lyfebloc_da_published_data_proto_rawDescData)
	})
	return file_lyfebloc_da_published_data_proto_rawDescData
}

var file_lyfebloc_da_published_data_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_lyfebloc_da_published_data_proto_goTypes = []interface{}{
	(*PublishedData)(nil),         // 0: lyfebloc.da.PublishedData
	(*Proof)(nil),                 // 1: lyfebloc.da.Proof
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*v1beta1.Coin)(nil),          // 3: cosmos.base.v1beta1.Coin
}
var file_lyfebloc_da_published_data_proto_depIdxs = []int32{
	2, // 0: lyfebloc.da.PublishedData.timestamp:type_name -> google.protobuf.Timestamp
	3, // 1: lyfebloc.da.PublishedData.collateral:type_name -> cosmos.base.v1beta1.Coin
	2, // 2: lyfebloc.da.PublishedData.challenge_timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_lyfebloc_da_published_data_proto_init() }
func file_lyfebloc_da_published_data_proto_init() {
	if File_lyfebloc_da_published_data_proto != nil {
		return
	}
	file_lyfebloc_da_params_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_lyfebloc_da_published_data_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_lyfebloc_da_published_data_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Proof); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lyfebloc_da_published_data_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_lyfebloc_da_published_data_proto_goTypes,
		DependencyIndexes: file_lyfebloc_da_published_data_proto_depIdxs,
		MessageInfos:      file_lyfebloc_da_published_data_proto_msgTypes,
	}.Build()
	File_lyfebloc_da_published_data_proto = out.File
	file_lyfebloc_da_published_data_proto_rawDesc = nil
	file_lyfebloc_da_published_data_proto_goTypes = nil
	file_lyfebloc_da_published_data_proto_depIdxs = nil
}
