...
func init() {
	...
	md_PacketIndex = File_lyfebloc_swap_in_flight_packet_proto.Messages().ByName("PacketIndex")
...
func (x *PacketIndex) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_swap_in_flight_packet_proto_msgTypes[0]
...
func (x *fastReflection_PacketIndex) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.swap.PacketIndex.port_id":
		return x.PortId != ""
	case "lyfebloc.swap.PacketIndex.channel_id":
		return x.ChannelId != ""
	case "lyfebloc.swap.PacketIndex.sequence":
		return x.Sequence != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.swap.PacketIndex"))
		}
		panic(fmt.Errorf("message lyfebloc.swap.PacketIndex does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PacketIndex) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.swap.PacketIndex does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PacketIndex) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "lyfebloc.swap.PacketIndex.port_id":
		panic(fmt.Errorf("field port_id of message lyfebloc.swap.PacketIndex is not mutable"))
	case "lyfebloc.swap.PacketIndex.channel_id":
		panic(fmt.Errorf("field channel_id of message lyfebloc.swap.PacketIndex is not mutable"))
	case "lyfebloc.swap.PacketIndex.sequence":
		panic(fmt.Errorf("field sequence of message lyfebloc.swap.PacketIndex is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.swap.PacketIndex"))
		}
...
func (x *fastReflection_PacketIndex) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.swap.PacketIndex", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_lyfebloc_swap_in_flight_packet_proto_init()
	md_IncomingInFlightPacket = File_lyfebloc_swap_in_flight_packet_proto.Messages().ByName("IncomingInFlightPacket")
...
func (x *IncomingInFlightPacket) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_swap_in_flight_packet_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_IncomingInFlightPacket) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.swap.IncomingInFlightPacket.index":
		return x.Index != nil
	case "lyfebloc.swap.IncomingInFlightPacket.data":
		return len(x.Data) != 0
	case "lyfebloc.swap.IncomingInFlightPacket.src_port_id":
		return x.SrcPortId != ""
	case "lyfebloc.swap.IncomingInFlightPacket.src_channel_id":
		return x.SrcChannelId != ""
	case "lyfebloc.swap.IncomingInFlightPacket.timeout_height":
		return x.TimeoutHeight != ""
	case "lyfebloc.swap.IncomingInFlightPacket.timeout_timestamp":
		return x.TimeoutTimestamp != uint64(0)
	case "lyfebloc.swap.IncomingInFlightPacket.ack":
		return len(x.Ack) != 0
	case "lyfebloc.swap.IncomingInFlightPacket.result":
		return x.Result != nil
	case "lyfebloc.swap.IncomingInFlightPacket.interface_fee":
		return x.InterfaceFee != ""
	case "lyfebloc.swap.IncomingInFlightPacket.outgoing_index_change":
		if x.Change == nil {
			return false
	...
	case "lyfebloc.swap.IncomingInFlightPacket.ack_change":
		if x.Change == nil {
			return false
	...
	case "lyfebloc.swap.IncomingInFlightPacket.outgoing_index_forward":
		if x.Forward == nil {
			return false
	...
	case "lyfebloc.swap.IncomingInFlightPacket.ack_forward":
		if x.Forward == nil {
			return false
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.swap.IncomingInFlightPacket"))
		}
		panic(fmt.Errorf("message lyfebloc.swap.IncomingInFlightPacket does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_IncomingInFlightPacket) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.swap.IncomingInFlightPacket does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_IncomingInFlightPacket) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "lyfebloc.swap.IncomingInFlightPacket.data":
		panic(fmt.Errorf("field data of message lyfebloc.swap.IncomingInFlightPacket is not mutable"))
	case "lyfebloc.swap.IncomingInFlightPacket.src_port_id":
		panic(fmt.Errorf("field src_port_id of message lyfebloc.swap.IncomingInFlightPacket is not mutable"))
	case "lyfebloc.swap.IncomingInFlightPacket.src_channel_id":
		panic(fmt.Errorf("field src_channel_id of message lyfebloc.swap.IncomingInFlightPacket is not mutable"))
	case "lyfebloc.swap.IncomingInFlightPacket.timeout_height":
		panic(fmt.Errorf("field timeout_height of message lyfebloc.swap.IncomingInFlightPacket is not mutable"))
	case "lyfebloc.swap.IncomingInFlightPacket.timeout_timestamp":
		panic(fmt.Errorf("field timeout_timestamp of message lyfebloc.swap.IncomingInFlightPacket is not mutable"))
	case "lyfebloc.swap.IncomingInFlightPacket.ack":
		panic(fmt.Errorf("field ack of message lyfebloc.swap.IncomingInFlightPacket is not mutable"))
	case "lyfebloc.swap.IncomingInFlightPacket.interface_fee":
		panic(fmt.Errorf("field interface_fee of message lyfebloc.swap.IncomingInFlightPacket is not mutable"))
	case "lyfebloc.swap.IncomingInFlightPacket.ack_change":
		panic(fmt.Errorf("field ack_change of message lyfebloc.swap.IncomingInFlightPacket is not mutable"))
	case "lyfebloc.swap.IncomingInFlightPacket.ack_forward":
		panic(fmt.Errorf("field ack_forward of message lyfebloc.swap.IncomingInFlightPacket is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.swap.IncomingInFlightPacket"))
		}
...
func (x *fastReflection_IncomingInFlightPacket) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "lyfebloc.swap.IncomingInFlightPacket.change":
		if x.Change == nil {
			return nil
		}
	...
	case "lyfebloc.swap.IncomingInFlightPacket.forward":
		if x.Forward == nil {
			return nil
		}
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.swap.IncomingInFlightPacket", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_lyfebloc_swap_in_flight_packet_proto_init()
	md_OutgoingInFlightPacket = File_lyfebloc_swap_in_flight_packet_proto.Messages().ByName("OutgoingInFlightPacket")
...
func (x *OutgoingInFlightPacket) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_swap_in_flight_packet_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_OutgoingInFlightPacket) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.swap.OutgoingInFlightPacket.index":
		return x.Index != nil
	case "lyfebloc.swap.OutgoingInFlightPacket.ack_waiting_index":
		return x.AckWaitingIndex != nil
	case "lyfebloc.swap.OutgoingInFlightPacket.retries_remaining":
		return x.RetriesRemaining != int32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.swap.OutgoingInFlightPacket"))
		}
		panic(fmt.Errorf("message lyfebloc.swap.OutgoingInFlightPacket does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_OutgoingInFlightPacket) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.swap.OutgoingInFlightPacket does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_OutgoingInFlightPacket) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "lyfebloc.swap.OutgoingInFlightPacket.retries_remaining":
		panic(fmt.Errorf("field retries_remaining of message lyfebloc.swap.OutgoingInFlightPacket is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.swap.OutgoingInFlightPacket"))
		}
...
func (x *fastReflection_OutgoingInFlightPacket) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.swap.OutgoingInFlightPacket", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: lyfebloc/swap/in_flight_packet.proto
...
func (*PacketIndex) Descriptor() ([]byte, []int) {
	return file_lyfebloc_swap_in_flight_packet_proto_rawDescGZIP(), []int{0}
}
...
func (*IncomingInFlightPacket) Descriptor() ([]byte, []int) {
	return file_lyfebloc_swap_in_flight_packet_proto_rawDescGZIP(), []int{1}
}
...
func (*OutgoingInFlightPacket) Descriptor() ([]byte, []int) {
	return file_lyfebloc_swap_in_flight_packet_proto_rawDescGZIP(), []int{2}
}
...
var File_lyfebloc_swap_in_flight_packet_proto protoreflect.FileDescriptor

var file_lyfebloc_swap_in_flight_packet_proto_rawDesc = []byte{
	0x0a, 0x24, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2f, 0x73, 0x77, 0x61, 0x70, 0x2f,
	0x69, 0x6e, 0x5f, 0x66, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63,
	...
	0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x19, 0x6c, 0x79, 0x66, 0x65, 0x62,
	0x6c, 0x6f, 0x63, 0x2f, 0x73, 0x77, 0x61, 0x70, 0x2f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x61, 0x0a, 0x0b, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x49, 0x6e,
	...
	,
	...
	0x65, 0x6f, 0x75, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x10, 0x0a,
	0x03, 0x61, 0x63, 0x6b, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x61, 0x63, 0x6b, 0x12,
	0x3d, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1a, 0x2e, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2e, 0x73, 0x77, 0x61, 0x70, 0x2e,
	...
	0x63, 0x65, 0x46, 0x65, 0x65, 0x12, 0x50, 0x0a, 0x15, 0x6f, 0x75, 0x74, 0x67, 0x6f, 0x69, 0x6e,
	0x67, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x0a,
	...
	,
	...
	,
}

var (
	file_lyfebloc_swap_in_flight_packet_proto_rawDescOnce sync.Once
	file_lyfebloc_swap_in_flight_packet_proto_rawDescData = file_lyfebloc_swap_in_flight_packet_proto_rawDesc
)

func file_lyfebloc_swap_in_flight_packet_proto_rawDescGZIP() []byte {
	file_lyfebloc_swap_in_flight_packet_proto_rawDescOnce.Do(func() {
		file_lyfebloc_swap_in_flight_packet_proto_rawDescData = protoimpl.X.CompressGZIP(file_lyfebloc_swap_in_flight_packet_proto_rawDescData)
	})
	return file_lyfebloc_swap_in_flight_packet_proto_rawDescData
}

var file_lyfebloc_swap_in_flight_packet_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_lyfebloc_swap_in_flight_packet_proto_goTypes = []interface{}{
	(*PacketIndex)(nil),            // 0: lyfebloc.swap.PacketIndex
	(*IncomingInFlightPacket)(nil), // 1: lyfebloc.swap.IncomingInFlightPacket
	(*OutgoingInFlightPacket)(nil), // 2: lyfebloc.swap.OutgoingInFlightPacket
	(*RouteResult)(nil),            // 3: lyfebloc.swap.RouteResult
}
var file_lyfebloc_swap_in_flight_packet_proto_depIdxs = []int32{
	0, // 0: lyfebloc.swap.IncomingInFlightPacket.index:type_name -> lyfebloc.swap.PacketIndex
	3, // 1: lyfebloc.swap.IncomingInFlightPacket.result:type_name -> lyfebloc.swap.RouteResult
	0, // 2: lyfebloc.swap.IncomingInFlightPacket.outgoing_index_change:type_name -> lyfebloc.swap.PacketIndex
	0, // 3: lyfebloc.swap.IncomingInFlightPacket.outgoing_index_forward:type_name -> lyfebloc.swap.PacketIndex
	0, // 4: lyfebloc.swap.OutgoingInFlightPacket.index:type_name -> lyfebloc.swap.PacketIndex
	0, // 5: lyfebloc.swap.OutgoingInFlightPacket.ack_waiting_index:type_name -> lyfebloc.swap.PacketIndex
...
func init() { file_lyfebloc_swap_in_flight_packet_proto_init() }
func file_lyfebloc_swap_in_flight_packet_proto_init() {
	if File_lyfebloc_swap_in_flight_packet_proto != nil {
		return
	}
	file_lyfebloc_swap_route_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_lyfebloc_swap_in_flight_packet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_lyfebloc_swap_in_flight_packet_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_lyfebloc_swap_in_flight_packet_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_lyfebloc_swap_in_flight_packet_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lyfebloc_swap_in_flight_packet_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_lyfebloc_swap_in_flight_packet_proto_goTypes,
		DependencyIndexes: file_lyfebloc_swap_in_flight_packet_proto_depIdxs,
		MessageInfos:      file_lyfebloc_swap_in_flight_packet_proto_msgTypes,
	}.Build()
	File_lyfebloc_swap_in_flight_packet_proto = out.File
	file_lyfebloc_swap_in_flight_packet_proto_rawDesc = nil
	file_lyfebloc_swap_in_flight_packet_proto_goTypes = nil
	file_lyfebloc_swap_in_flight_packet_proto_depIdxs = nil
}
