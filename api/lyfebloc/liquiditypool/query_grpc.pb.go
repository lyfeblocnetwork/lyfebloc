...
const (
	Query_Params_FullMethodName                       = "/lyfebloc.liquiditypool.Query/Params"
	Query_Pool_FullMethodName                         = "/lyfebloc.liquiditypool.Query/Pool"
	Query_Pools_FullMethodName                        = "/lyfebloc.liquiditypool.Query/Pools"
	Query_Position_FullMethodName                     = "/lyfebloc.liquiditypool.Query/Position"
	Query_Positions_FullMethodName                    = "/lyfebloc.liquiditypool.Query/Positions"
	Query_PoolPositions_FullMethodName                = "/lyfebloc.liquiditypool.Query/PoolPositions"
	Query_AddressPositions_FullMethodName             = "/lyfebloc.liquiditypool.Query/AddressPositions"
	Query_PositionFees_FullMethodName                 = "/lyfebloc.liquiditypool.Query/PositionFees"
	Query_CalculationCreatePosition_FullMethodName    = "/lyfebloc.liquiditypool.Query/CalculationCreatePosition"
	Query_CalculationIncreaseLiquidity_FullMethodName = "/lyfebloc.liquiditypool.Query/CalculationIncreaseLiquidity"
)
