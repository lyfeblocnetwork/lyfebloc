...
func init() {
	...
	md_Pool = File_lyfebloc_liquiditypool_pool_proto.Messages().ByName("Pool")
...
func (x *Pool) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_liquiditypool_pool_proto_msgTypes[0]
...
func (x *fastReflection_Pool) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.liquiditypool.Pool.id":
		return x.Id != uint64(0)
	case "lyfebloc.liquiditypool.Pool.denom_base":
		return x.DenomBase != ""
	case "lyfebloc.liquiditypool.Pool.denom_quote":
		return x.DenomQuote != ""
	case "lyfebloc.liquiditypool.Pool.fee_rate":
		return x.FeeRate != ""
	case "lyfebloc.liquiditypool.Pool.tick_params":
		return x.TickParams != nil
	case "lyfebloc.liquiditypool.Pool.current_tick":
		return x.CurrentTick != int64(0)
	case "lyfebloc.liquiditypool.Pool.current_tick_liquidity":
		return x.CurrentTickLiquidity != ""
	case "lyfebloc.liquiditypool.Pool.current_sqrt_price":
		return x.CurrentSqrtPrice != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.liquiditypool.Pool"))
		}
		panic(fmt.Errorf("message lyfebloc.liquiditypool.Pool does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Pool) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.liquiditypool.Pool does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Pool) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "lyfebloc.liquiditypool.Pool.id":
		panic(fmt.Errorf("field id of message lyfebloc.liquiditypool.Pool is not mutable"))
	case "lyfebloc.liquiditypool.Pool.denom_base":
		panic(fmt.Errorf("field denom_base of message lyfebloc.liquiditypool.Pool is not mutable"))
	case "lyfebloc.liquiditypool.Pool.denom_quote":
		panic(fmt.Errorf("field denom_quote of message lyfebloc.liquiditypool.Pool is not mutable"))
	case "lyfebloc.liquiditypool.Pool.fee_rate":
		panic(fmt.Errorf("field fee_rate of message lyfebloc.liquiditypool.Pool is not mutable"))
	case "lyfebloc.liquiditypool.Pool.current_tick":
		panic(fmt.Errorf("field current_tick of message lyfebloc.liquiditypool.Pool is not mutable"))
	case "lyfebloc.liquiditypool.Pool.current_tick_liquidity":
		panic(fmt.Errorf("field current_tick_liquidity of message lyfebloc.liquiditypool.Pool is not mutable"))
	case "lyfebloc.liquiditypool.Pool.current_sqrt_price":
		panic(fmt.Errorf("field current_sqrt_price of message lyfebloc.liquiditypool.Pool is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.liquiditypool.Pool"))
		}
...
func (x *fastReflection_Pool) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.liquiditypool.Pool", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_lyfebloc_liquiditypool_pool_proto_init()
	md_TickParams = File_lyfebloc_liquiditypool_pool_proto.Messages().ByName("TickParams")
...
func (x *TickParams) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_liquiditypool_pool_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_TickParams) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.liquiditypool.TickParams.price_ratio":
		return x.PriceRatio != ""
	case "lyfebloc.liquiditypool.TickParams.base_offset":
		return x.BaseOffset != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.liquiditypool.TickParams"))
		}
		panic(fmt.Errorf("message lyfebloc.liquiditypool.TickParams does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TickParams) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.liquiditypool.TickParams does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TickParams) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "lyfebloc.liquiditypool.TickParams.price_ratio":
		panic(fmt.Errorf("field price_ratio of message lyfebloc.liquiditypool.TickParams is not mutable"))
	case "lyfebloc.liquiditypool.TickParams.base_offset":
		panic(fmt.Errorf("field base_offset of message lyfebloc.liquiditypool.TickParams is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.liquiditypool.TickParams"))
		}
...
func (x *fastReflection_TickParams) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.liquiditypool.TickParams", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Pool) Descriptor() ([]byte, []int) {
	return file_lyfebloc_liquiditypool_pool_proto_rawDescGZIP(), []int{0}
}
...
func (*TickParams) Descriptor() ([]byte, []int) {
	return file_lyfebloc_liquiditypool_pool_proto_rawDescGZIP(), []int{1}
}
...
var File_lyfebloc_liquiditypool_pool_proto protoreflect.FileDescriptor

var file_lyfebloc_liquiditypool_pool_proto_rawDesc = []byte{
	0x0a, 0x21, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2f, 0x6c, 0x69, 0x71, 0x75, 0x69,
	0x64, 0x69, 0x74, 0x79, 0x70, 0x6f, 0x6f, 0x6c, 0x2f, 0x70, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x16, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2e, 0x6c, 0x69,
	...
	0xf0, 0x03, 0x0a, 0x04, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x64, 0x65, 0x6e, 0x6f,
	0x6d, 0x5f, 0x62, 0x61, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x65,
	0x6e, 0x6f, 0x6d, 0x42, 0x61, 0x73, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x64, 0x65, 0x6e, 0x6f, 0x6d,
	0x5f, 0x71, 0x75, 0x6f, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x64, 0x65,
	0x6e, 0x6f, 0x6d, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x12, 0x51, 0x0a, 0x08, 0x66, 0x65, 0x65, 0x5f,
	0x72, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x36, 0xc8, 0xde, 0x1f, 0x00,
	...
	0x2a, 0x01, 0x52, 0x07, 0x66, 0x65, 0x65, 0x52, 0x61, 0x74, 0x65, 0x12, 0x4e, 0x0a, 0x0b, 0x74,
	0x69, 0x63, 0x6b, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x22, 0x2e, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2e, 0x6c, 0x69, 0x71, 0x75,
	0x69, 0x64, 0x69, 0x74, 0x79, 0x70, 0x6f, 0x6f, 0x6c, 0x2e, 0x54, 0x69, 0x63, 0x6b, 0x50, 0x61,
	...
	0x03, 0x52, 0x0b, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x54, 0x69, 0x63, 0x6b, 0x12, 0x6c,
	0x0a, 0x16, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x69, 0x63, 0x6b, 0x5f, 0x6c,
	0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x42, 0x36,
	...
	0x63, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x14, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x54,
	0x69, 0x63, 0x6b, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x12, 0x64, 0x0a, 0x12,
	0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x71, 0x72, 0x74, 0x5f, 0x70, 0x72, 0x69,
	0x63, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x42, 0x36, 0xc8, 0xde, 0x1f, 0x00, 0xda, 0xde,
	...
	0x52, 0x10, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x53, 0x71, 0x72, 0x74, 0x50, 0x72, 0x69,
	0x63, 0x65, 0x22, 0xbe, 0x01, 0x0a, 0x0a, 0x54, 0x69, 0x63, 0x6b, 0x50, 0x61, 0x72, 0x61, 0x6d,
	0x73, 0x12, 0x57, 0x0a, 0x0b, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x70, 0x72, 0x69, 0x63, 0x65, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x12, 0x57, 0x0a, 0x0b, 0x62, 0x61,
	0x73, 0x65, 0x5f, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42,
	...
	,
}

var (
	file_lyfebloc_liquiditypool_pool_proto_rawDescOnce sync.Once
	file_lyfebloc_liquiditypool_pool_proto_rawDescData = file_lyfebloc_liquiditypool_pool_proto_rawDesc
)

func file_lyfebloc_liquiditypool_pool_proto_rawDescGZIP() []byte {
	file_lyfebloc_liquiditypool_pool_proto_rawDescOnce.Do(func() {
		file_lyfebloc_liquiditypool_pool_proto_rawDescData = protoimpl.X.CompressGZIP(file_lyfebloc_liquiditypool_pool_proto_rawDescData)
	})
	return file_lyfebloc_liquiditypool_pool_proto_rawDescData
}

var file_lyfebloc_liquiditypool_pool_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_lyfebloc_liquiditypool_pool_proto_goTypes = []interface{}{
	(*Pool)(nil),       // 0: lyfebloc.liquiditypool.Pool
	(*TickParams)(nil), // 1: lyfebloc.liquiditypool.TickParams
}
var file_lyfebloc_liquiditypool_pool_proto_depIdxs = []int32{
	1, // 0: lyfebloc.liquiditypool.Pool.tick_params:type_name -> lyfebloc.liquiditypool.TickParams
...
func init() { file_lyfebloc_liquiditypool_pool_proto_init() }
func file_lyfebloc_liquiditypool_pool_proto_init() {
	if File_lyfebloc_liquiditypool_pool_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_lyfebloc_liquiditypool_pool_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pool); i {
			case 0:
				return &v.state
			case 1:
		...
		file_lyfebloc_liquiditypool_pool_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lyfebloc_liquiditypool_pool_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_lyfebloc_liquiditypool_pool_proto_goTypes,
		DependencyIndexes: file_lyfebloc_liquiditypool_pool_proto_depIdxs,
		MessageInfos:      file_lyfebloc_liquiditypool_pool_proto_msgTypes,
	}.Build()
	File_lyfebloc_liquiditypool_pool_proto = out.File
	file_lyfebloc_liquiditypool_pool_proto_rawDesc = nil
	file_lyfebloc_liquiditypool_pool_proto_goTypes = nil
	file_lyfebloc_liquiditypool_pool_proto_depIdxs = nil
}
