...
func init() {
	file_lyfebloc_liquiditypool_ticker_proto_init()
	md_TickInfo = File_lyfebloc_liquiditypool_ticker_proto.Messages().ByName("TickInfo")
...
func (x *TickInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_liquiditypool_ticker_proto_msgTypes[0]
...
func (x *fastReflection_TickInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.liquiditypool.TickInfo.pool_id":
		return x.PoolId != uint64(0)
	case "lyfebloc.liquiditypool.TickInfo.tick_index":
		return x.TickIndex != int64(0)
	case "lyfebloc.liquiditypool.TickInfo.liquidity_gross":
		return x.LiquidityGross != ""
	case "lyfebloc.liquiditypool.TickInfo.liquidity_net":
		return x.LiquidityNet != ""
	case "lyfebloc.liquiditypool.TickInfo.fee_growth":
		return len(x.FeeGrowth) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.liquiditypool.TickInfo"))
		}
		panic(fmt.Errorf("message lyfebloc.liquiditypool.TickInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TickInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.liquiditypool.TickInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TickInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "lyfebloc.liquiditypool.TickInfo.pool_id":
		panic(fmt.Errorf("field pool_id of message lyfebloc.liquiditypool.TickInfo is not mutable"))
	case "lyfebloc.liquiditypool.TickInfo.tick_index":
		panic(fmt.Errorf("field tick_index of message lyfebloc.liquiditypool.TickInfo is not mutable"))
	case "lyfebloc.liquiditypool.TickInfo.liquidity_gross":
		panic(fmt.Errorf("field liquidity_gross of message lyfebloc.liquiditypool.TickInfo is not mutable"))
	case "lyfebloc.liquiditypool.TickInfo.liquidity_net":
		panic(fmt.Errorf("field liquidity_net of message lyfebloc.liquiditypool.TickInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.liquiditypool.TickInfo"))
		}
...
func (x *fastReflection_TickInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.liquiditypool.TickInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func (*TickInfo) Descriptor() ([]byte, []int) {
	return file_lyfebloc_liquiditypool_ticker_proto_rawDescGZIP(), []int{0}
}
...
var File_lyfebloc_liquiditypool_ticker_proto protoreflect.FileDescriptor

var file_lyfebloc_liquiditypool_ticker_proto_rawDesc = []byte{
	0x0a, 0x23, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2f, 0x6c, 0x69, 0x71, 0x75, 0x69,
	0x64, 0x69, 0x74, 0x79, 0x70, 0x6f, 0x6f, 0x6c, 0x2f, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x72, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x16, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2e,
	0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x70, 0x6f, 0x6f, 0x6c, 0x1a, 0x14, 0x67,
	...
	,
	...
	0x2e, 0x44, 0x65, 0x63, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x09, 0x66, 0x65, 0x65, 0x47, 0x72,
	0x6f, 0x77, 0x74, 0x68, 0x42, 0xcb, 0x01, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x6c, 0x79, 0x66,
	0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2e, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x70,
	0x6f, 0x6f, 0x6c, 0x42, 0x0b, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_lyfebloc_liquiditypool_ticker_proto_rawDescOnce sync.Once
	file_lyfebloc_liquiditypool_ticker_proto_rawDescData = file_lyfebloc_liquiditypool_ticker_proto_rawDesc
)

func file_lyfebloc_liquiditypool_ticker_proto_rawDescGZIP() []byte {
	file_lyfebloc_liquiditypool_ticker_proto_rawDescOnce.Do(func() {
		file_lyfebloc_liquiditypool_ticker_proto_rawDescData = protoimpl.X.CompressGZIP(file_lyfebloc_liquiditypool_ticker_proto_rawDescData)
	})
	return file_lyfebloc_liquiditypool_ticker_proto_rawDescData
}

var file_lyfebloc_liquiditypool_ticker_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_lyfebloc_liquiditypool_ticker_proto_goTypes = []interface{}{
	(*TickInfo)(nil),        // 0: lyfebloc.liquiditypool.TickInfo
	(*v1beta1.DecCoin)(nil), // 1: cosmos.base.v1beta1.DecCoin
}
var file_lyfebloc_liquiditypool_ticker_proto_depIdxs = []int32{
	1, // 0: lyfebloc.liquiditypool.TickInfo.fee_growth:type_name -> cosmos.base.v1beta1.DecCoin
...
func init() { file_lyfebloc_liquiditypool_ticker_proto_init() }
func file_lyfebloc_liquiditypool_ticker_proto_init() {
	if File_lyfebloc_liquiditypool_ticker_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_lyfebloc_liquiditypool_ticker_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lyfebloc_liquiditypool_ticker_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_lyfebloc_liquiditypool_ticker_proto_goTypes,
		DependencyIndexes: file_lyfebloc_liquiditypool_ticker_proto_depIdxs,
		MessageInfos:      file_lyfebloc_liquiditypool_ticker_proto_msgTypes,
	}.Build()
	File_lyfebloc_liquiditypool_ticker_proto = out.File
	file_lyfebloc_liquiditypool_ticker_proto_rawDesc = nil
	file_lyfebloc_liquiditypool_ticker_proto_goTypes = nil
	file_lyfebloc_liquiditypool_ticker_proto_depIdxs = nil
}
