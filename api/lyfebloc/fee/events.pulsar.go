...
func init() {
	file_lyfebloc_fee_events_proto_init()
	md_EventFeeBurnt = File_lyfebloc_fee_events_proto.Messages().ByName("EventFeeBurnt")
...
func (x *EventFeeBurnt) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_fee_events_proto_msgTypes[0]
...
func (x *fastReflection_EventFeeBurnt) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.fee.EventFeeBurnt.fees":
		return len(x.Fees) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.fee.EventFeeBurnt"))
		}
		panic(fmt.Errorf("message lyfebloc.fee.EventFeeBurnt does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventFeeBurnt) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.fee.EventFeeBurnt does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventFeeBurnt) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.fee.EventFeeBurnt", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: lyfebloc/fee/events.proto
...
func (*EventFeeBurnt) Descriptor() ([]byte, []int) {
	return file_lyfebloc_fee_events_proto_rawDescGZIP(), []int{0}
}
...
var File_lyfebloc_fee_events_proto protoreflect.FileDescriptor

var file_lyfebloc_fee_events_proto_rawDesc = []byte{
	0x0a, 0x19, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2f, 0x66, 0x65, 0x65, 0x2f, 0x65,
	0x76, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x6c, 0x79, 0x66,
	0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2e, 0x66, 0x65, 0x65, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70,
	...
	0x63, 0x6f, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x70, 0x0a, 0x0d, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x46, 0x65, 0x65, 0x42, 0x75, 0x72, 0x6e, 0x74, 0x12, 0x5f, 0x0a, 0x04, 0x66,
	...
	0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x04, 0x66, 0x65, 0x65, 0x73, 0x42, 0x8f, 0x01, 0x0a,
	0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2e, 0x66, 0x65,
	...
	0x70, 0x69, 0x2f, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x2f, 0x66, 0x65, 0x65, 0xa2,
	0x02, 0x03, 0x4c, 0x46, 0x58, 0xaa, 0x02, 0x0c, 0x4c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63,
	0x2e, 0x46, 0x65, 0x65, 0xca, 0x02, 0x0c, 0x4c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x5c,
	0x46, 0x65, 0x65, 0xe2, 0x02, 0x18, 0x4c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x5c, 0x46,
	0x65, 0x65, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02,
	0x0d, 0x4c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f, 0x63, 0x3a, 0x3a, 0x46, 0x65, 0x65, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_lyfebloc_fee_events_proto_rawDescOnce sync.Once
	file_lyfebloc_fee_events_proto_rawDescData = file_lyfebloc_fee_events_proto_rawDesc
)

func file_lyfebloc_fee_events_proto_rawDescGZIP() []byte {
	file_lyfebloc_fee_events_proto_rawDescOnce.Do(func() {
		file_lyfebloc_fee_events_proto_rawDescData = protoimpl.X.CompressGZIP(file_lyfebloc_fee_events_proto_rawDescData)
	})
	return file_lyfebloc_fee_events_proto_rawDescData
}

var file_lyfebloc_fee_events_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_lyfebloc_fee_events_proto_goTypes = []interface{}{
	(*EventFeeBurnt)(nil), // 0: lyfebloc.fee.EventFeeBurnt
	(*v1beta1.Coin)(nil),  // 1: cosmos.base.v1beta1.Coin
}
var file_lyfebloc_fee_events_proto_depIdxs = []int32{
	1, // 0: lyfebloc.fee.EventFeeBurnt.fees:type_name -> cosmos.base.v1beta1.Coin
...
func init() { file_lyfebloc_fee_events_proto_init() }
func file_lyfebloc_fee_events_proto_init() {
	if File_lyfebloc_fee_events_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_lyfebloc_fee_events_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lyfebloc_fee_events_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_lyfebloc_fee_events_proto_goTypes,
		DependencyIndexes: file_lyfebloc_fee_events_proto_depIdxs,
		MessageInfos:      file_lyfebloc_fee_events_proto_msgTypes,
	}.Build()
	File_lyfebloc_fee_events_proto = out.File
	file_lyfebloc_fee_events_proto_rawDesc = nil
	file_lyfebloc_fee_events_proto_goTypes = nil
	file_lyfebloc_fee_events_proto_depIdxs = nil
}
