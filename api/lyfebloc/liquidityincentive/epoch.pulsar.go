...
func init() {
	...
	md_Epoch = File_lyfebloc_liquidityincentive_epoch_proto.Messages().ByName("Epoch")
...
func (x *Epoch) slowProtoReflect() protoreflect.Message {
	mi := &file_lyfebloc_liquidityincentive_epoch_proto_msgTypes[0]
...
func (x *fastReflection_Epoch) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lyfebloc.liquidityincentive.Epoch.id":
		return x.Id != uint64(0)
	case "lyfebloc.liquidityincentive.Epoch.start_block":
		return x.StartBlock != int64(0)
	case "lyfebloc.liquidityincentive.Epoch.end_block":
		return x.EndBlock != int64(0)
	case "lyfebloc.liquidityincentive.Epoch.gauges":
		return len(x.Gauges) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.liquidityincentive.Epoch"))
		}
		panic(fmt.Errorf("message lyfebloc.liquidityincentive.Epoch does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Epoch) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lyfebloc.liquidityincentive.Epoch does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Epoch) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "lyfebloc.liquidityincentive.Epoch.id":
		panic(fmt.Errorf("field id of message lyfebloc.liquidityincentive.Epoch is not mutable"))
	case "lyfebloc.liquidityincentive.Epoch.start_block":
		panic(fmt.Errorf("field start_block of message lyfebloc.liquidityincentive.Epoch is not mutable"))
	case "lyfebloc.liquidityincentive.Epoch.end_block":
		panic(fmt.Errorf("field end_block of message lyfebloc.liquidityincentive.Epoch is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lyfebloc.liquidityincentive.Epoch"))
		}
...
func (x *fastReflection_Epoch) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lyfebloc.liquidityincentive.Epoch", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: lyfebloc/liquidityincentive/epoch.proto
...
func (*Epoch) Descriptor() ([]byte, []int) {
	return file_lyfebloc_liquidityincentive_epoch_proto_rawDescGZIP(), []int{0}
}
...
var File_lyfebloc_liquidityincentive_epoch_proto protoreflect.FileDescriptor

var file_lyfebloc_liquidityincentive_epoch_proto_rawDesc = []byte{
	...
	0x6f, 0x63, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1b, 0x6c, 0x79, 0x66, 0x65, 0x62,
	0x6c, 0x6f, 0x63, 0x2e, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x69, 0x6e, 0x63,
	0x65, 0x6e, 0x74, 0x69, 0x76, 0x65, 0x1a, 0x19, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67,
	0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x27, 0x6c, 0x79, 0x66, 0x65, 0x62, 0x6c, 0x6f,
	...
	,
	...
	,
}

var (
	file_lyfebloc_liquidityincentive_epoch_proto_rawDescOnce sync.Once
	file_lyfebloc_liquidityincentive_epoch_proto_rawDescData = file_lyfebloc_liquidityincentive_epoch_proto_rawDesc
)

func file_lyfebloc_liquidityincentive_epoch_proto_rawDescGZIP() []byte {
	file_lyfebloc_liquidityincentive_epoch_proto_rawDescOnce.Do(func() {
		file_lyfebloc_liquidityincentive_epoch_proto_rawDescData = protoimpl.X.CompressGZIP(file_lyfebloc_liquidityincentive_epoch_proto_rawDescData)
	})
	return file_lyfebloc_liquidityincentive_epoch_proto_rawDescData
}

var file_lyfebloc_liquidityincentive_epoch_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_lyfebloc_liquidityincentive_epoch_proto_goTypes = []interface{}{
	(*Epoch)(nil), // 0: lyfebloc.liquidityincentive.Epoch
	(*Gauge)(nil), // 1: lyfebloc.liquidityincentive.Gauge
}
var file_lyfebloc_liquidityincentive_epoch_proto_depIdxs = []int32{
	1, // 0: lyfebloc.liquidityincentive.Epoch.gauges:type_name -> lyfebloc.liquidityincentive.Gauge
...
func init() { file_lyfebloc_liquidityincentive_epoch_proto_init() }
func file_lyfebloc_liquidityincentive_epoch_proto_init() {
	if File_lyfebloc_liquidityincentive_epoch_proto != nil {
		return
	}
	file_lyfebloc_liquidityincentive_gauge_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_lyfebloc_liquidityincentive_epoch_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Epoch); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lyfebloc_liquidityincentive_epoch_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_lyfebloc_liquidityincentive_epoch_proto_goTypes,
		DependencyIndexes: file_lyfebloc_liquidityincentive_epoch_proto_depIdxs,
		MessageInfos:      file_lyfebloc_liquidityincentive_epoch_proto_msgTypes,
	}.Build()
	File_lyfebloc_liquidityincentive_epoch_proto = out.File
	file_lyfebloc_liquidityincentive_epoch_proto_rawDesc = nil
	file_lyfebloc_liquidityincentive_epoch_proto_goTypes = nil
	file_lyfebloc_liquidityincentive_epoch_proto_depIdxs = nil
}
