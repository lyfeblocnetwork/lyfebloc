...
import (
	...
	"github.com/lyfeblocnetwork/lyfebloc/encoding"
	"github.com/lyfeblocnetwork/lyfebloc/x/evm/core/vm"

	// unnamed import of statik for swagger UI support
	_ "github.com/lyfeblocnetwork/lyfebloc/client/docs/statik"
	"github.com/lyfeblocnetwork/lyfebloc/utils"

	lyfebloctypes "github.com/lyfeblocnetwork/lyfebloc/types"
	"github.com/lyfeblocnetwork/lyfebloc/x/epochs"
	epochskeeper "github.com/lyfeblocnetwork/lyfebloc/x/epochs/keeper"
	epochstypes "github.com/lyfeblocnetwork/lyfebloc/x/epochs/types"
	"github.com/lyfeblocnetwork/lyfebloc/x/evm"
	evmkeeper "github.com/lyfeblocnetwork/lyfebloc/x/evm/keeper"
	evmtypes "github.com/lyfeblocnetwork/lyfebloc/x/evm/types"
	inflation "github.com/lyfeblocnetwork/lyfebloc/x/inflation/v1"
	inflationkeeper "github.com/lyfeblocnetwork/lyfebloc/x/inflation/v1/keeper"
	inflationtypes "github.com/lyfeblocnetwork/lyfebloc/x/inflation/v1/types"

	"github.com/lyfeblocnetwork/lyfebloc/app/ante"
	ethante "github.com/lyfeblocnetwork/lyfebloc/app/ante/evm"
	"github.com/lyfeblocnetwork/lyfebloc/app/post"
	srvflags "github.com/lyfeblocnetwork/lyfebloc/server/flags"
	"github.com/lyfeblocnetwork/lyfebloc/x/erc20"
	erc20keeper "github.com/lyfeblocnetwork/lyfebloc/x/erc20/keeper"
	erc20types "github.com/lyfeblocnetwork/lyfebloc/x/erc20/types"
	"github.com/lyfeblocnetwork/lyfebloc/x/feemarket"
	feemarketkeeper "github.com/lyfeblocnetwork/lyfebloc/x/feemarket/keeper"
	feemarkettypes "github.com/lyfeblocnetwork/lyfebloc/x/feemarket/types"
	"github.com/lyfeblocnetwork/lyfebloc/x/staking"
	stakingkeeper "github.com/lyfeblocnetwork/lyfebloc/x/staking/keeper"
	"github.com/lyfeblocnetwork/lyfebloc/x/vesting"
	vestingkeeper "github.com/lyfeblocnetwork/lyfebloc/x/vesting/keeper"
	vestingtypes "github.com/lyfeblocnetwork/lyfebloc/x/vesting/types"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/lyfeblocnetwork/lyfebloc/x/ibc/transfer"
	transferkeeper "github.com/lyfeblocnetwork/lyfebloc/x/ibc/transfer/keeper"

	memiavlstore "github.com/crypto-org-chain/cronos/store"

	// Force-load the tracer engines to trigger registration due to Go-Ethereum v1.10.15 changes
	_ "github.com/lyfeblocnetwork/lyfebloc/x/evm/core/tracers/js"
	_ "github.com/lyfeblocnetwork/lyfebloc/x/evm/core/tracers/native"
)
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".lyfeblocd")

	// manually update the power reduction by replacing micro (u) -> atto (a) lyfebloc
	sdk.DefaultPowerReduction = lyfebloctypes.PowerReduction
...
var (
	_ servertypes.Application = (*Lyfebloc)(nil)
	_ ibctesting.TestingApp   = (*Lyfebloc)(nil)
	_ runtime.AppI            = (*Lyfebloc)(nil)
)

// Lyfebloc implements an extended ABCI application. It is an application
// that may process transactions through Ethereum's EVM running atop of
// Tendermint consensus.
type Lyfebloc struct {
	*baseapp.BaseApp
...
func (*Lyfebloc) SimulationManager() *module.SimulationManager {
	panic("unimplemented")
}

// NewLyfebloc returns a reference to a new initialized Ethermint application.
func NewLyfebloc(
	logger log.Logger,
	db dbm.DB,
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		...
		lyfebloctypes.ProtoAccount, maccPerms,
...
func (app *Lyfebloc) Name() string { return app.BaseApp.Name() }

func (app *Lyfebloc) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
...
func (app *Lyfebloc) setPostHandler() {
...
func (app *Lyfebloc) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.mm.BeginBlock(ctx)
}

// EndBlocker updates every end block
func (app *Lyfebloc) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.mm.EndBlock(ctx)
}

// The DeliverTx method is intentionally decomposed to calculate the transactions per second.
func (app *Lyfebloc) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	defer func() {
...
func (app *Lyfebloc) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *Lyfebloc) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.mm.PreBlock(ctx)
}

// LoadHeight loads state at a particular height
func (app *Lyfebloc) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Lyfebloc) ModuleAccountAddrs() map[string]bool {
...
//   - the static precompiled contracts available through Lyfebloc
func (app *Lyfebloc) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Lyfebloc's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Lyfebloc) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Lyfebloc's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Lyfebloc) AppCodec() codec.Codec {
	return app.appCodec
}

// DefaultGenesis returns a default genesis from the registered AppModuleBasic's.
func (app *Lyfebloc) DefaultGenesis() lyfebloctypes.GenesisState {
	return app.BasicModuleManager.DefaultGenesis(app.appCodec)
}

// InterfaceRegistry returns Lyfebloc's InterfaceRegistry
func (app *Lyfebloc) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Lyfebloc) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Lyfebloc) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Lyfebloc) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Lyfebloc) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *Lyfebloc) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Lyfebloc) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *Lyfebloc) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Lyfebloc) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *Lyfebloc) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Lyfebloc) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Lyfebloc) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Lyfebloc) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Lyfebloc) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Lyfebloc) GetTxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *Lyfebloc) AutoCliOpts() autocli.AppOptions {
...
func (app *Lyfebloc) setupUpgradeHandlers() {
