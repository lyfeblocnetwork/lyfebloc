...
func (GovModuleBasic) DefaultGenesis(cdc codec.JSONCodec) json.RawMessage {
	...
	genState.Params.MinDeposit = sdk.NewCoins(
		sdk.NewCoin("uvbloc", sdkmath.NewInt(1_000_000_000)),
		sdk.NewCoin("ubloc", sdkmath.NewInt(1_000_000_000*2)),
	)
	genState.Params.ExpeditedMinDeposit = sdk.NewCoins(
		sdk.NewCoin("uvbloc", sdkmath.NewInt(1_000_000_000*5)),
		sdk.NewCoin("ubloc", sdkmath.NewInt(1_000_000_000*5*2)),
	)
