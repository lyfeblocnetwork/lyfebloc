...
import (
	...
	"github.com/lyfeblocnetwork/lyfebloc/app/defaultoverrides"
	"github.com/lyfeblocnetwork/lyfebloc/app/encoding"
	apperr "github.com/lyfeblocnetwork/lyfebloc/app/errors"
	"github.com/lyfeblocnetwork/lyfebloc/pkg/appconsts"
	apprand "github.com/lyfeblocnetwork/lyfebloc/pkg/random"
	"github.com/lyfeblocnetwork/lyfebloc/pkg/user"
	testutil "github.com/lyfeblocnetwork/lyfebloc/test/util"
	...
	blob "github.com/lyfeblocnetwork/lyfebloc/x/blob/types"
)
...
func TestInsufficientMinGasPriceIntegration(t *testing.T) {
	...
	minGasPrice, err := sdk.ParseDecCoins(fmt.Sprintf("%v%s", appconsts.DefaultMinGasPrice, "ubloc"))
	...
	fee := sdk.NewCoins(sdk.NewCoin("ubloc", sdkmath.NewInt(feeAmount)))
...
func TestInsufficientMinGasPriceTable(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			err:                          errors.Wrap(sdkerrors.ErrInsufficientFee, "insufficient fees; got: 10ubloc required: 100ubloc"),
			inputGasPrice:                0.01,
		...
		},
		{
			...
			err:                          errors.Wrap(sdkerrors.ErrInsufficientFee, "insufficient fees; got: 0ubloc required: 100ubloc"),
			inputGasPrice:                0,
			inputGasLimit:                100,
			expectedGasPrice:             1,
			isInsufficientMinGasPriceErr: true,
		...
		},
		{
			...
			err:                          errors.Wrap(sdkerrors.ErrInsufficientFee, "insufficient fees; got: 10ubloc required: 0ubloc"),
			isInsufficientMinGasPriceErr: true,
			expectParsingError:           true,
		},
		{
			name:                         "error with extra wrapping",
			err:                          errors.Wrap(errors.Wrap(sdkerrors.ErrInsufficientFee, "insufficient fees; got: 10ubloc required: 100ubloc"), "extra wrapping"),
			inputGasPrice:                0.01,
			expectedGasPrice:             0.1,
			isInsufficientMinGasPriceErr: true,
		},
