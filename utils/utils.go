...
const (
	// MainnetChainID defines the Lyfebloc EIP155 chain ID for mainnet
	MainnetChainID = "lyfebloc_1776"
	// TestnetChainID defines the Lyfebloc EIP155 chain ID for testnet
	TestnetChainID = "lyfebloc_1775"
	// TestingChainID defines the Lyfebloc EIP155 chain ID for integration test
	TestingChainID = "test_1775"
	// BaseDenom defines the Lyfebloc mainnet denomination
	BaseDenom = "alyfe"
)
...
// IsTestnet returns true if the chain-id has the Lyfebloc testnet EIP155 chain prefix.
...
// GetLyfeblocAddressFromBech32 returns the sdk.Account address of given address,
